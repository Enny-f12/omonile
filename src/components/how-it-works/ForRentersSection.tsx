  ...
  return (
    <div>
      ...
      <div style={{ marginTop: '2rem', padding: '2rem 2.5rem', background: 'linear-gradient(135deg,#0d3d22,#1a6b3c)', borderRadius: '16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1.25rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.65rem' }}>
          <Link href="/coming-soon" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '7px', padding: '0.85rem 1.75rem', borderRadius: '9999px', border: '1px solid #e8a84c', background: '#e8a84c', color: '#0d3d22', fontFamily: 'var(--font-body)', fontWeight: 700, fontSize: '0.9rem', textDecoration: 'none' }}>
            Search Verified Properties <ArrowRight size={16} strokeWidth={2.5} />
          </Link>
          <Link href="/coming-soon" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '7px', padding: '0.7rem 1.5rem', borderRadius: '9999px', border: '1px solid rgba(255,255,255,0.35)', background: 'transparent', color: 'white', fontFamily: 'var(--font-body)', fontWeight: 600, fontSize: '0.875rem', textDecoration: 'none' }}>
